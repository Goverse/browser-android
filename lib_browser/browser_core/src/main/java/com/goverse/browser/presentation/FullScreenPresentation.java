...
public class FullScreenPresentation extends Presentation {
    ...
    private final String TAG = "FullScreenPresentation";
    ...
    public FullScreenPresentation(Context context, String title) {
        super(context, R.layout.lib_browser_theme_fullscreen, title);
    ...
    public void onReceivedTitle(Browser browser, String title) {
        ...
        if (!isFixedTitle) toolbar.setTitle(title);
    }
    ...
    protected void showErrorView(Browser browser, String failUrl, int errorCode) {
